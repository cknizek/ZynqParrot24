...
While I was able to get `bsg_mul_add_unsigned.sv` to synthesize with the Lakeroad Yosys plugin, it required a lot of hacks that need to be improved. I ultimately ended up directly re-writing the file to incorporate `bsg_dff_chain.sv`, because I was unable to get Lakeroad to successfully synthesize the top-level file otherwise. 

One thing you may notice is that the bit-widths for the inputs are fairly small. This is because `bsg_dff.sv` will consolidate the widths of `width_a_p`, `width_b_p`, and `width_c_p` in the `pre_mul_add` section. 
...
module in_module #(
    ...
    // pre_mul_add
    // pre_width_p = width_a_p + width_b_p + width_c_p
    // num_stages_p = pre_pipeline_lp
    // pre_data_o = pre_data_i
    ...
    if(pre_pipeline_lp == 0) begin:pass_through
            ...
            genvar i;
            for(i=1; i<= 1; i++) begin
                    bsg_dff #( .width_p ( pre_width_p ) )
                            ch_reg (
                                    .clk_i        ( clk_i                 )
                                    ,.data_i         ( pre_data_delayed[ i-1 ]   )
                                    ,.data_o         ( pre_data_delayed[ i   ]   )
                            );
            end
    ...
    if( post_pipeline_lp == 0) begin:pass_through_post
            ...
            genvar i;
            for(i=1; i<= 1; i++) begin
                    bsg_dff #( .width_p ( width_o_p ) )
                            ch_reg (
                                    .clk_i        ( clk_i                 )
                                    ,.data_i         ( post_data_delayed[ i-1 ]   )
                                    ,.data_o         ( post_data_delayed[ i   ]   )
                            );
            end
...
This file is synthesized by Lakeroad as the following:

```verilog
/* Generated by Yosys 0.42 (git sha1 9b6afcf3f, clang++ 15.0.0 -fPIC -Os) */

(* cells_not_processed =  1  *)
(* src = "/var/folders/rg/jq5symwd1cnc731n43t_4dd00000gn/T/8773-6412-5c0d-51a9.v:3.1-112.10" *)
module out_module(a_i, b_i, c_i, clk_i, o);
  (* src = "/var/folders/rg/jq5symwd1cnc731n43t_4dd00000gn/T/8773-6412-5c0d-51a9.v:4.15-4.18" *)
  wire [47:0] P_0;
  (* src = "/var/folders/rg/jq5symwd1cnc731n43t_4dd00000gn/T/8773-6412-5c0d-51a9.v:5.15-5.18" *)
  input [3:0] a_i;
  wire [3:0] a_i;
  (* src = "/var/folders/rg/jq5symwd1cnc731n43t_4dd00000gn/T/8773-6412-5c0d-51a9.v:7.15-7.18" *)
  input [3:0] b_i;
  wire [3:0] b_i;
  (* src = "/var/folders/rg/jq5symwd1cnc731n43t_4dd00000gn/T/8773-6412-5c0d-51a9.v:9.15-9.18" *)
  input [7:0] c_i;
  wire [7:0] c_i;
  (* src = "/var/folders/rg/jq5symwd1cnc731n43t_4dd00000gn/T/8773-6412-5c0d-51a9.v:11.9-11.14" *)
  input clk_i;
  wire clk_i;
  (* src = "/var/folders/rg/jq5symwd1cnc731n43t_4dd00000gn/T/8773-6412-5c0d-51a9.v:13.16-13.17" *)
  output [8:0] o;
  wire [8:0] o;
  (* module_not_derived = 32'd1 *)
  (* src = "/var/folders/rg/jq5symwd1cnc731n43t_4dd00000gn/T/8773-6412-5c0d-51a9.v:62.5-102.4" *)
  DSP48E2 #(
    .ACASCREG(32'd0),
    .ADREG(32'd0),
    .ALUMODEREG(32'd0),
...
(* dynports =  1  *)
(* top =  1  *)
(* src = "/Users/colinknizek/dev/lakeroad_bitbit/lakeroad/integration_tests/lakeroad/bsg_mul_add_unsigned/bsg_mul_add_unsigned_synth.sv:17.1-103.10" *)
module out_module(a_i, b_i, c_i, clk_i, o);
  (* src = "/Users/colinknizek/dev/lakeroad_bitbit/lakeroad/integration_tests/lakeroad/bsg_mul_add_unsigned/bsg_mul_add_unsigned_synth.sv:80.32-80.47" *)
  wire [8:0] _0_;
  (* src = "/Users/colinknizek/dev/lakeroad_bitbit/lakeroad/integration_tests/lakeroad/bsg_mul_add_unsigned/bsg_mul_add_unsigned_synth.sv:80.32-80.41" *)
  wire [8:0] _1_;
  (* data = 32'd1 *)
  ...
  input [7:0] c_i;
  wire [7:0] c_i;
  (* src = "/Users/colinknizek/dev/lakeroad_bitbit/lakeroad/integration_tests/lakeroad/bsg_mul_add_unsigned/bsg_mul_add_unsigned_synth.sv:45.26-45.29" *)
  wire [7:0] c_r;
  (* clk = 32'd1 *)
  ...
  output [8:0] o;
  wire [8:0] o;
  (* src = "/Users/colinknizek/dev/lakeroad_bitbit/lakeroad/integration_tests/lakeroad/bsg_mul_add_unsigned/bsg_mul_add_unsigned_synth.sv:80.26-80.29" *)
  wire [8:0] o_r;
  (* src = "/Users/colinknizek/dev/lakeroad_bitbit/lakeroad/integration_tests/lakeroad/bsg_mul_add_unsigned/bsg_mul_add_unsigned_synth.sv:60.18-60.24" *)
  wire \pass_through.unused ;
  (* src = "/Users/colinknizek/dev/lakeroad_bitbit/lakeroad/integration_tests/lakeroad/bsg_mul_add_unsigned/bsg_mul_add_unsigned_synth.sv:84.18-84.24" *)
  wire \pass_through_post.unused ;
  (* src = "/Users/colinknizek/dev/lakeroad_bitbit/lakeroad/integration_tests/lakeroad/bsg_mul_add_unsigned/bsg_mul_add_unsigned_synth.sv:47.16-47.33" *)
  wire [1:0] \post_data_delayed[0] ;
  (* src = "/Users/colinknizek/dev/lakeroad_bitbit/lakeroad/integration_tests/lakeroad/bsg_mul_add_unsigned/bsg_mul_add_unsigned_synth.sv:47.16-47.33" *)
  wire [1:0] \post_data_delayed[1] ;
  (* src = "/Users/colinknizek/dev/lakeroad_bitbit/lakeroad/integration_tests/lakeroad/bsg_mul_add_unsigned/bsg_mul_add_unsigned_synth.sv:47.16-47.33" *)
  ...
  (* src = "/Users/colinknizek/dev/lakeroad_bitbit/lakeroad/integration_tests/lakeroad/bsg_mul_add_unsigned/bsg_mul_add_unsigned_synth.sv:56.16-56.32" *)
  wire [1:0] \pre_data_delayed[0] ;
  (* src = "/Users/colinknizek/dev/lakeroad_bitbit/lakeroad/integration_tests/lakeroad/bsg_mul_add_unsigned/bsg_mul_add_unsigned_synth.sv:56.16-56.32" *)
  ...
  (* src = "/Users/colinknizek/dev/lakeroad_bitbit/lakeroad/integration_tests/lakeroad/bsg_mul_add_unsigned/bsg_mul_add_unsigned_synth.sv:55.28-55.38" *)
  wire [15:0] pre_data_i;
  (* src = "/Users/colinknizek/dev/lakeroad_bitbit/lakeroad/integration_tests/lakeroad/bsg_mul_add_unsigned/bsg_mul_add_unsigned_synth.sv:54.28-54.38" *)
  wire [15:0] pre_data_o;
  assign _0_ = _1_ + (* src = "/Users/colinknizek/dev/lakeroad_bitbit/lakeroad/integration_tests/lakeroad/bsg_mul_add_unsigned/bsg_mul_add_unsigned_synth.sv:80.32-80.47" *) c_r;
  assign _1_ = a_r * (* src = "/Users/colinknizek/dev/lakeroad_bitbit/lakeroad/integration_tests/lakeroad/bsg_mul_add_unsigned/bsg_mul_add_unsigned_synth.sv:80.32-80.41" *) b_r;
  assign pre_data_i = { a_i, b_i, c_i };
  assign o_r = _0_;
  assign \pass_through.unused  = clk_i;
  assign pre_data_o = pre_data_i;
  assign \pass_through_post.unused  = clk_i;
  assign o = o_r;
endmodule
